...
import { Menu, X, LogIn, UserPlus, User, Settings, History as HistoryIcon, LogOut } from "lucide-react";
...
const BottomBar = ({ onShowAuth, onShowSettings, onShowHistory }: BottomBarProps) => {
